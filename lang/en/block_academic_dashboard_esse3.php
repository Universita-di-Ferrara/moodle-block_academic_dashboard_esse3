...
$string['academic_dashboard_esse3:view'] = 'View Academic Dashboard (Esse3) block content';
...
$string['cachedef_course_teachers'] = 'Resolved Moodle course teacher names';
$string['cachedef_transcript'] = 'Student career and transcript data fetched from Esse3';
$string['cachedef_user_status'] = 'Cached student status inferred from Moodle and Esse3 data';
...
$string['matricolafield'] = 'Student matricola field';
$string['matricolafield_desc'] = 'The Moodle user field whose value is sent to Esse3 as the student matricola. Supports standard fields (e.g. idnumber) and custom profile fields. Defaults to "idnumber" if left empty.';
...
$string['privacy:metadata:esse3:matricola'] = 'The student matricola sent to Esse3 to identify the current user.';
...
$string['privacy:missingmatricola'] = 'The current user does not have a configured ESSE3 matricola.';
...
$string['studentdomain_desc'] = 'Email domain used to identify students before calling Esse3. Supports one or more domains separated by commas, spaces, or semicolons (e.g., student.unife.it). Leave empty to keep the ESSE3 lookup enabled for all users.';

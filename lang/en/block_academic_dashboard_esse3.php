...
$string['matricolafield'] = 'Matricola Field';
$string['matricolafield_desc'] = 'The user field that contains the student matricola, including custom profile fields (e.g., idnumber or esse3Matricola).';
...
$string['privacy:metadata:esse3:matricola'] = 'The student matricola used to identify the current user in ESSE3.';
...
$string['privacy:missingmatricola'] = 'The current user does not have a configured matricola for ESSE3 access.';
